...
- اگر از Skill داخل Codex App استفاده می‌کنید، بعد از JSON یک پیام کوتاه راهنما/سوال نمایش داده می‌شود. این پیام جدا از JSON است. برای خروجی کاملاً خام، صریحاً بگویید «JSON-only».
