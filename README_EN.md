...
- When using the Skill inside the Codex App, a short follow-up message may appear after the JSON. If you need raw output only, explicitly ask for “JSON-only”.
